...
def get_arguments():
    ...
    config=self_path + '/data/wavenet/config.json'
    mode='inference'
    load_checkpoint=self_path + '/data/vctk/checkpoints/config1_epoch0033.pth'
    condition_value=0
    batch_size=4
    one_shot=False
    clean_input_path=self_path +'/data/vctk/clean_testset_wav/'
    noisy_input_path=self_path +'/data/vctk/noisy_testset_wav/'
...
#        return datasets.DemandDataset(config, model).load_dataset()
